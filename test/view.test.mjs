...
test("a location border is bold from afar and disappears at half screen", () => {
  assert.equal(locationBorderScreenWidth(12, 9, 1, 1000, 800), 8);
...
test("a location border stays bold until the card is a speck", () => {
  assert.ok(locationBorderScreenWidth(80, 60, 1, 1000, 800) > 6);
  assert.ok(locationBorderScreenWidth(20, 16, 1, 1000, 800) > 7);
});

test("a location border thins back to a hair on the world map", () => {
  assert.equal(locationBorderScreenWidth(3, 2.4, 1, 1000, 800), 1);
  assert.equal(locationBorderScreenWidth(1, 1, 1, 1000, 800), 1);
  const between = locationBorderScreenWidth(6, 5, 1, 1000, 800);
