...
// Підпис картки має бути видно повністю: дрібний текст можна дочитати, наблизивши
// дошку, а обрізаний — лише відкривши картку. Тож йому межа значно нижча.
export const SUMMARY_MIN_RATIO = 0.2;
